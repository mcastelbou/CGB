...
public class TransferRestController {
	 ...
	 * 
	 * @param id L'identifiant unique du transfert à supprimer, renseigné dans le
	 *           corps de la requête.
	 * @return L'objet supprimé si l'opération a réussi. Une réponse 'BAD_REQUEST'
	 *         si une RuntimeException ou une DeleteTransferException est
	 *         rencontrée.
	 */
