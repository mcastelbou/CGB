...
public class JwtService {
	...
	/*
	 * S2 private static final String SECRET_KEY = "secret"; private static final
	 * String FIXED_SUBJECT = "user123";
	 * 
	 * public String generateToken() { return Jwts.builder()
	 * .setSubject(FIXED_SUBJECT) .setIssuedAt(new Date(0)) // Date fixe
