...
public class IbanGenerator {
	...
	private static String calculateCheckDigits(String countryCode, String bban) {
		...
		/*
		 * Formatage du chiffre de contrôle en deux chiffres % : Indique le début d'un
		 * spécificateur de format. 0 : Indique que le nombre doit être complété avec
		 * des zéros à gauche si nécessaire. 2 : Indique la largeur minimale du champ,
		 * ici 2 caractères. d : Indique que le type de donnée est un entier
		 * -->"décimal" pas un double ni float. ex: si nombre 5 --> 05 , si 12 --> 12
		 */
